    ...
    public class VectorMathNode : RuntimeNode {
        ...
        private float3 CalculateVector() {
            return operation switch {
                ...
                VectorMathNode_Operation.SmoothMinimum => new float3(ExtraMath.SmoothMinimum(x.x, y.x, distance), 
                                                                     ExtraMath.SmoothMinimum(x.y, y.y, distance), 
                                                                     ExtraMath.SmoothMinimum(x.z, y.z, distance)),
                VectorMathNode_Operation.SmoothMaximum => new float3(ExtraMath.SmoothMaximum(x.x, y.x, distance), 
                                                                     ExtraMath.SmoothMaximum(x.y, y.y, distance), 
                                                                     ExtraMath.SmoothMaximum(x.z, y.z, distance)),
                ...
                VectorMathNode_Operation.Wrap => new float3(ExtraMath.Wrap(x.x, y.x, wrapMax.x),
                                                            ExtraMath.Wrap(x.y, y.y, wrapMax.y),
                                                            ExtraMath.Wrap(x.z, y.z, wrapMax.z)),
