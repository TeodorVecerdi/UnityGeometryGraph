...
namespace GeometryGraph.Editor.Utils {
    public class MathUtils {
        ...
        public static void QuaternionNormalize(ref Quaternion q) {
            float num = 1f / Mathf.Sqrt((float)(q.x * (double)q.x + q.y * (double)q.y + q.z * (double)q.z + q.w * (double)q.w));
            q.x *= num;
            q.y *= num;
            q.z *= num;
            q.w *= num;
        ...
        public static Quaternion GetQuatExp(Quaternion q) {
            Quaternion quaternion = q;
            float f1 = Mathf.Sqrt((float)(q.x * (double)q.x + q.y * (double)q.y + q.z * (double)q.z));
            float f2 = Mathf.Sin(f1);
        ...
        public static Quaternion GetQuatSquad(float t, Quaternion q0, Quaternion q1, Quaternion a0, Quaternion a1) {
            ...
            Quaternion quaternion = Slerp(Slerp(q0, q1, t), Slerp(a0, a1, t), t1);
            float num = Mathf.Sqrt((float)(quaternion.x * (double)quaternion.x + quaternion.y * (double)quaternion.y + quaternion.z * (double)quaternion.z +
        ...
        public static float Ease(float t, float k1, float k2) {
            float num = (float)(k1 * 2.0 / 3.14159274101257 + k2 - k1 + (1.0 - k2) * 2.0 / 3.14159274101257);
            return (t >= (double)k1
                ? t >= (double)k2
        ...
        public static Quaternion Slerp(Quaternion p, Quaternion q, float t) {
            ...
            if (1.0 + f1 > 1E-05) {
                ...
                float num4 = Mathf.Sin((float)((1.0 - t) * 3.14159274101257 * 0.5));
                float num5 = Mathf.Sin((float)(t * 3.14159274101257 * 0.5));
        ...
        public static Vector3 ClosestPtSegmentRay(Vector3 p1, Vector3 q1, Ray ray, out float squaredDist, out float s, out Vector3 closestRay) {
            ...
            if (num1 <= (double)Mathf.Epsilon) {
                ...
                if (num2 <= (double)Mathf.Epsilon) {
                    ...
                    float num7 = (float)(num1 * (double)num2 - num6 * (double)num6);
