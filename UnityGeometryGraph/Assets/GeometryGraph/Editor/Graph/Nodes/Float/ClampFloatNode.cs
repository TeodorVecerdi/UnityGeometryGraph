...
namespace GeometryGraph.Editor {
    ...
    public class ClampFloatNode : AbstractNode<GeometryGraph.Runtime.Graph.ClampFloatNode> {
        ...
        public override void InitializeNode(EdgeConnectorListener edgeConnectorListener) {
            ...
            (minPort, minField) = GraphFrameworkPort.CreateWithBackingField<FloatField, float>("Min", Orientation.Horizontal, PortType.Float, edgeConnectorListener, this);
            (maxPort, maxField) = GraphFrameworkPort.CreateWithBackingField<FloatField, float>("Max", Orientation.Horizontal, PortType.Float, edgeConnectorListener, this);
