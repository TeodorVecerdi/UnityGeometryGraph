...
namespace GeometryGraph.Editor {
    public class StringPropertyNode : AbstractNode<GeometryGraph.Runtime.Graph.StringPropertyNode> {
        ...
        protected override void CreateNode() {
            propertyPort = GraphFrameworkPort.Create("Value", Direction.Output, Port.Capacity.Multi, PortType.String, this);
        ...
        protected internal override void Deserialize(JObject data) {
            ...
            PropertyGuid = data.Value<string>("g");
