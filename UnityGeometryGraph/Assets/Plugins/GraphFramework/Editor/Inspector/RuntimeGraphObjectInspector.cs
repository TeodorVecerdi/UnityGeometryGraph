...
namespace GraphFramework.Editor {
  ...
  !! * Kept as reference for later
    ...
    public class DlogObjectEditor : UnityEditor.Editor {
        ...
        private RuntimeGraphObject RuntimeGraphObject {
            get => (RuntimeGraphObject) dlogObjectProperty.objectReferenceValue;
        ...
        private UnityEditor.SerializedProperty CurrentDataProperty {
            get {
                var currentIndex = runtimeGraph.CurrentIndex;
        ...
        public void OnEnable() {
            runtimeGraph = (RuntimeGraph) target;
        ...
        public override VisualElement CreateInspectorGUI() {
            ...
            dlogObjectField.RegisterCallback<ChangeEvent<Object>>(evt => {
                dlogObjectProperty.objectReferenceValue = (RuntimeGraphObject) evt.newValue;
        ...
        private void UpdateInspectorProperties() {
            if (RuntimeGraphObject == null) return;
            var currentData = runtimeGraph.CurrentData;
            UpdatePersistentData();
            ...
            var actorProperties = RuntimeGraphObject.Properties.Where(property => property.Type == PropertyType.Actor).ToList();
            ...
            var checkProperties = RuntimeGraphObject.Properties.Where(property => property.Type == PropertyType.Check).ToList();
            ...
            foreach (var triggerProperty in RuntimeGraphObject.Properties.Where(property => property.Type == PropertyType.Trigger)) {
        ...
        #1#
            ...
            var triggerProperties = RuntimeGraphObject.Properties.Where(property => property.Type == PropertyType.Trigger).ToList();
